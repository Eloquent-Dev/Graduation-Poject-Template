    ...
    <div class="mr-auto ml-auto px-6 py-8 lg:px-8 w-[50%]">
        ...
        <form action="{{ route('complaints.store') }}" method="post" class="space-y-6" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" placeholder="What's the title of your issue.. ?" name="title" value="{{ old('title') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-blue outline-none">
